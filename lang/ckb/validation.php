...
return [
    ...
    'ascii' => 'پێویستە :attribute تەنها پیت و ژمارە و هێماکانی یەک-بایتی لەخۆبگرێت.',
    'can' => ':attribute نرخێکی نامۆڵەتداری لەخۆدەگرێت.',
    'decimal' => 'پێویستە :attribute :decimal شوێنی دەیی هەبێت.',
    'extensions' => 'پێویستە :attribute یەکێک لەم پاشگرەکانەی هەبێت: :values.',
    'hex_color' => 'پێویستە :attribute ڕەنگێکی دووانزەیی دروست بێت.',
    'lowercase' => 'پێویستە :attribute پیتی بچووک بێت.',
    'missing' => 'پێویستە :attribute نەبێت.',
    'missing_if' => 'پێویستە :attribute نەبێت کاتێک :other :value بێت.',
    'missing_unless' => 'پێویستە :attribute نەبێت مەگەر :other :value بێت.',
    'missing_with' => 'پێویستە :attribute نەبێت کاتێک :values هەبێت.',
    'missing_with_all' => 'پێویستە :attribute نەبێت کاتێک :values هەبن.',
    'present_if' => 'پێویستە :attribute هەبێت کاتێک :other :value بێت.',
    'present_unless' => 'پێویستە :attribute هەبێت مەگەر :other :value بێت.',
    'present_with' => 'پێویستە :attribute هەبێت کاتێک :values هەبێت.',
    'present_with_all' => 'پێویستە :attribute هەبێت کاتێک :values هەبن.',
    'required_if_accepted' => 'پێویستە :attribute داواکرابێت کاتێک :other قبوڵکرابێت.',
    'uppercase' => 'پێویستە :attribute پیتی گەورە بێت.',
    'ulid' => 'پێویستە :attribute ناسنامەیەکی دروستی ULID بێت.',
    'attributes' => [
    ],
    ...
    |--------------------------------------------------------------------------
    */
    'file_too_large' => 'فایلەکە زۆر گەورەیە. زۆرترین قەبارەی ڕێگەپێدراو :max.',
    'video_max_size' => 'ڤیدیۆکە دەبێت گەورەتر نەبێت لە :max.',
];