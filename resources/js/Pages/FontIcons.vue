    ...
    <div>
        <div class="space-y-8">
            <div class="panel">
                ...
                <div class="mb-5">
                    <p class="mb-5">
                        Solar is a collection of simply beautiful open source icons. Each icon is designed on a 24x24 grid
                        ...
                        <div
                            ...
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <path
                                    ...
                                    fill="currentColor" />
                                <path opacity="0.5" d="M9.5 9L10.0282 12.1179" stroke="currentColor" stroke-width="1.5"
                                    stroke-linecap="round" />
                                <path opacity="0.5" d="M15.5283 9L15.0001 12.1179" stroke="currentColor" stroke-width="1.5"
                                    stroke-linecap="round" />
                            </svg>
                        </div>
                        <div
                    ...
                    <div class="bg-[#009688]/[.26] text-[#009688] py-1 px-2 rounded inline-block text-base mb-5">Outline
                    </div>
                    <div class="flex items-center flex-wrap gap-10 mb-5">
                        <div
                            class="grid place-content-center w-14 h-14 border border-white-dark/20 dark:border-[#191e3a] rounded-md">
                        ...
                        <div
                            ...
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <path d="M4 15L9 17.1875M20 22L14.5 19.5938" stroke="currentColor" stroke-width="1.5"
                                    stroke-linecap="round" />
                                <path d="M15 10C14.8 10.6667 13.92 12 12 12" stroke="currentColor" stroke-width="1.5"
                                    stroke-linecap="round" />
                            </svg>
                        </div>
                        <div
                        ...
                        <div
                            ...
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path
                                    ...
                                    stroke="currentColor" stroke-width="1.5" stroke-linecap="round" />
                                <path d="M13.9868 5L12 12.4149L10.0132 19.8297" stroke="currentColor" stroke-width="1.5"
                                    stroke-linecap="round" />
                                <path
