        ...
        <div class="pt-5 grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div class="panel">
                ...
                <div class="mb-5 dark:text-white-dark">
                    <p class="mb-5">Badges scale to match the size of the immediate parent element by using relative font
                        sizing and em units.</p>
                    ...
                    <div class="flex flex-wrap items-center justify-center gap-3">
                        <button type="button" class="btn btn-primary my-4">
                            <span class="flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24"
                                    ...
                                    stroke-linejoin="round" class="w-4.5 h-4.5 ltr:mr-1 rtl:ml-1">
                        ...
                        <button type="button" class="btn btn-info my-4">
                            <span>Twitter</span><span
                                class="badge absolute ltr:right-0 rtl:left-0 -top-3 bg-danger p-0.5 px-1.5 rounded-full">4</span>
                        </button>
