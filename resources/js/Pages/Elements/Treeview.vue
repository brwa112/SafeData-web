                    ...
                    <ul class="font-semibold no-animtion">
                        <li>
                            <button type="button" @click="toggleTreeview2('parent-node')">
                                <svg v-if="treeview2.includes('parent-node')" width="24" height="24" viewBox="0 0 24 24"
                                ...
                                <ul>
                                    <li class="py-[5px] ltr:pl-7 rtl:pr-7">
                                        <button type="button" @click="toggleTreeview2('img')">
                                            <svg v-if="treeview2.includes('img')" width="24" height="24" viewBox="0 0 24 24"
                                                fill="none" xmlns="http://www.w3.org/2000/svg"
                                                class="w-5 h-5 text-primary inline relative -top-1 ltr:mr-2 rtl:ml-2">
                                                <path opacity="0.5" d="M14 14H10" stroke="currentColor" stroke-width="1.5"
                                                    stroke-linecap="round" />
                                    ...
                                    <li class="py-[5px] ltr:pl-7 rtl:pr-7">
                                        <button type="button" @click="toggleTreeview2('css')">
                                            <svg v-if="treeview2.includes('css')" width="24" height="24" viewBox="0 0 24 24"
                                                fill="none" xmlns="http://www.w3.org/2000/svg"
                                                class="w-5 h-5 text-primary inline relative -top-1 ltr:mr-2 rtl:ml-2">
                                                <path opacity="0.5" d="M14 14H10" stroke="currentColor" stroke-width="1.5"
                                                    stroke-linecap="round" />
                                    ...
                                    <li class="py-[5px] ltr:pl-7 rtl:pr-7">
                                        <button type="button" @click="toggleTreeview2('js')">
                                            <svg v-if="treeview2.includes('js')" width="24" height="24" viewBox="0 0 24 24"
                                                fill="none" xmlns="http://www.w3.org/2000/svg"
                                                class="w-5 h-5 text-primary inline relative -top-1 ltr:mr-2 rtl:ml-2">
                                                <path opacity="0.5" d="M14 14H10" stroke="currentColor" stroke-width="1.5"
                                                    stroke-linecap="round" />
...
const treeview1 = ref(['images']);
const treeview2 = ref(['parent-node']);
...
const toggleTreeview2 = (name) => {
    if (treeview2.value.includes(name)) {
        treeview2.value = treeview2.value.filter((d) => d != name);
    } else {
        treeview2.value.push(name);
    }
};
</script>
