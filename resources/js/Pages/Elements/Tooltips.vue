    ...
    <div>
        ...
        <div class="pt-5 space-y-8">
            <div class="panel p-3 flex items-center text-primary overflow-x-auto whitespace-nowrap">
                ...
                <span class="ltr:mr-3 rtl:ml-3">Documentation: </span><a href="https://www.npmjs.com/package/tippy.vue"
                    target="_blank" class="block hover:underline">https://www.npmjs.com/package/tippy.vue</a>
            </div>
                ...
                <div class="panel">
                    ...
                    <div class="mb-5">
                        <div class="flex flex-wrap justify-center gap-4 w-full">
                            ...
                            <tippy target="left" :placement="rtlClass === 'rtl' ? 'right' : 'left'">Popover on left
                            </tippy>

                            <button type="button" v-tippy:bottom class="btn btn-warning">Tooltip on bottom</button>
                            <tippy target="bottom" placement="top">Popover on bottom</tippy>

                            <button type="button" v-tippy:right class="btn btn-danger">Tooltip on right</button>
                            <tippy target="right" :placement="rtlClass === 'rtl' ? 'left' : 'right'">Popover on right
                            </tippy>
                        </div>
                    </div>
                </div>
