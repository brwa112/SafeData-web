    ...
    <div>
        ...
        <div class="pt-5 grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div class="panel">
                ...
                <div class="mb-5">
                    <ol class="flex text-gray-500 font-semibold dark:text-white-dark">
                        <li><a href="javascript:;" class="hover:text-gray-500/70 dark:hover:text-white-dark/70">Home</a>
                        </li>
                        <li
                            ...
                            <a class="p-2.5 border border-gray-500/20 rounded-md shadow flex items-center justify-center dark:border-0 dark:bg-[#191e3a] hover:text-gray-500/70 dark:hover:text-white-dark/70"
                                ...
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    ...
                                    <path opacity="0.5"
                                        ...
                                        stroke="currentColor" stroke-width="1.5" />
                                    <path d="M12.4286 10L11 12H13L11.5714 14" stroke="currentColor" stroke-width="1.5"
