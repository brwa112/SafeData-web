                ...
                <div class="mb-5">
                    <div class="flex flex-wrap w-full justify-center">
                        <div
                            ...
                            <p class="text-white-dark text-[15px] mb-3.5">Lorem ipsum dolor sit amet, labore et dolore magna
                                aliqua.</p>
                ...
                <div class="mb-5">
                    <div class="flex flex-wrap w-full justify-center">
                        <div
                            ...
                            <p class="text-white-light text-[15px] mb-3.5">Lorem ipsum dolor sit amet, labore et dolore
                                magna aliqua.</p>
