    ...
    <div>
        ...
        <div class="grid sm:grid-cols-2 xl:grid-cols-3 gap-6 mb-6">
            <div class="panel h-full sm:col-span-2 xl:col-span-1">
                ...
                <div>
                    <apexchart height="160" :options="dailySales" :series="dailySalesSeries"
                        class="bg-white dark:bg-black rounded-lg">
                        <!-- loader -->
                        <div
                    ...
                    <div class="flex justify-between items-center mb-6">
                        <div
                            ...
                            <img class="w-8 h-8 rounded-full border-2 border-white/50 block object-cover ltr:mr-1 rtl:ml-1"
                                src="/public/assets/images/profile-34.jpeg" alt="" />
                            Alan Green
                        </div>
                        <button type="button"
                        ...
                        <tbody>
                                ...
                                <td class="min-w-[150px] text-black dark:text-white">
                                    <div class="flex items-center">
                                        <img class="w-8 h-8 rounded-md ltr:mr-3 rtl:ml-3 object-cover"
                                            src="/public/assets/images/profile-6.jpeg" alt="avatar" />
                            ...
                            <tr class="text-white-dark hover:text-black dark:hover:text-white-light/90 group">
                                <td class="text-black dark:text-white">
                                    <div class="flex items-center">
                                        <img class="w-8 h-8 rounded-md ltr:mr-3 rtl:ml-3 object-cover"
                                            src="/public/assets/images/profile-7.jpeg" alt="avatar" />
                            ...
                            <tr class="text-white-dark hover:text-black dark:hover:text-white-light/90 group">
                                <td class="text-black dark:text-white">
                                    <div class="flex items-center">
                                        <img class="w-8 h-8 rounded-md ltr:mr-3 rtl:ml-3 object-cover"
                                            src="/public/assets/images/profile-8.jpeg" alt="avatar" />
                            ...
                            <tr class="text-white-dark hover:text-black dark:hover:text-white-light/90 group">
                                <td class="text-black dark:text-white">
                                    <div class="flex items-center">
                                        <img class="w-8 h-8 rounded-md ltr:mr-3 rtl:ml-3 object-cover"
                                            src="/public/assets/images/profile-9.jpeg" alt="avatar" />
                            ...
                            <tr class="text-white-dark hover:text-black dark:hover:text-white-light/90 group">
                                <td class="text-black dark:text-white">
                                    <div class="flex items-center">
                                        <img class="w-8 h-8 rounded-md ltr:mr-3 rtl:ml-3 object-cover"
                                            src="/public/assets/images/profile-10.jpeg" alt="avatar" />
        ...
        <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
            ...
            <div class="panel h-full">
                ...
                <div class="text-[#e95f2b] text-3xl font-bold my-10">
                    ...
                    <svg class="w-5 h-5 text-success inline" viewBox="0 0 24 24" fill="none"
                        ...
                        <path d="M22.0001 12.5458V7H16.418" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                            stroke-linejoin="round" />
                    </svg>
                </div>
                <div class="flex items-center justify-between">
            ...
            <div class="panel h-full overflow-hidden before:bg-[#1937cc] before:absolute before:-right-44 before:top-0 before:bottom-0 before:m-auto before:rounded-full before:w-96 before:h-96 grid grid-cols-1 content-between"
                ...
                <div class="flex items-center justify-between z-10">
                    ...
                    <a href="javascript:;"
                        class="shadow-[0_0_2px_0_#bfc9d4] rounded p-1 text-white-light hover:bg-[#4361ee] z-10"> Upgrade
                    </a>
                </div>
            </div>
        </div>
        ...
        <div class="grid sm:grid-cols-3 xl:grid-cols-5 gap-6 mb-6">
            ...
            <div class="panel h-full p-0">
                ...
                <div class="h-40">
                    <apexchart height="160" :options="engagement" :series="engagementSeries"
                    ...
                    <div class="w-full absolute bottom-0 flex items-center justify-between p-5 -mx-5">
                        ...
                        <a href="javascript:;"
                            ...
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"
                                ...
                                <path d="M11 19L17 12L11 5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                                    stroke-linejoin="round" />
                ...
                <div
                    ...
                    <div class="flex">
                        <div class="media-aside align-self-start">
                            <div class="ring-2 ring-white-light dark:ring-dark rounded-full ltr:mr-4 rtl:ml-4">
                                <img src="/public/assets/images/g-8.png" alt=""
                                    class="w-10 h-10 rounded-full object-cover" />
                            </div>
                        </div>
                        <div class="font-semibold">
                ...
                <div class="font-semibold text-center pb-8">
                    ...
                    <div class="flex items-center justify-center gap-3 pb-8">
                        <img class="w-10 h-10 ring-2 ring-white-light dark:ring-dark rounded-lg overflow-hidden object-cover"
                            src="/public/assets/images/profile-1.jpeg" alt="" />
                        <img class="w-10 h-10 ring-2 ring-white-light dark:ring-dark rounded-lg overflow-hidden object-cover"
                            src="/public/assets/images/profile-2.jpeg" alt="" />
                        <img class="w-10 h-10 ring-2 ring-white-light dark:ring-dark rounded-lg overflow-hidden object-cover"
                            src="/public/assets/images/profile-3.jpeg" alt="" />
                        <img class="w-10 h-10 ring-2 ring-white-light dark:ring-dark rounded-lg overflow-hidden object-cover"
                            src="/public/assets/images/profile-4.jpeg" alt="" />
                    </div>
                ...
                <div class="group">
                    <div class="mb-5">
                        <div class="text-white-dark">
                            Doloribus nisi vel suscipit modi, optio ex repudiandae voluptatibus officiis commodi. Nesciunt
                    ...
                    <div class="rounded-full h-2.5 p-0.5 bg-dark-light dark:bg-dark-light/10 mb-5">
                        <div class="bg-gradient-to-r from-[#1e9afe] to-[#60dfcd] h-full rounded-full" style="width: 65%">
                        </div>
                    </div>
                    <div class="flex items-end justify-between">
                        ...
                        <div
                            ...
                            <img class="w-9 h-9 border-2 border-white dark:border-dark rounded-full object-cover transition-all duration-300"
                                src="/public/assets/images/profile-6.jpeg" alt="" />
                            <img class="w-9 h-9 border-2 border-white dark:border-dark rounded-full object-cover transition-all duration-300"
                                src="/public/assets/images/profile-7.jpeg" alt="" />
                            <img class="w-9 h-9 border-2 border-white dark:border-dark rounded-full object-cover transition-all duration-300"
                                src="/public/assets/images/profile-8.jpeg" alt="" />
                        </div>
                    </div>
                </div>
            </div>
...
const revenueChart = computed(() => {
    ...
    const isRtl = rtlClass.value === 'rtl' ? true : false;
    return {
        chart: {
            height: 325,
            type: 'area',
...
// followers
const isDark1 = theme.value === 'dark' ? true : false;
