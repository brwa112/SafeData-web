              ...
              <tbody>
                <template v-for="data in tableData" :key="data.id">
                  <tr>
                    ...
                    <td>{{ data.email }}</td>
                    <td>
                      <span class="badge whitespace-nowrap" :class="{
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="h-1.5 bg-[#ebedf2] dark:bg-dark/40 rounded-full flex w-full">
                        <div class="h-1.5 rounded-full rounded-bl-full text-center text-white text-xs" :class="{
                    ...
                    <td class="whitespace-nowrap" :class="{
                      'text-success': data.status === 'Complete',
                      'text-secondary': data.status === 'Pending',
                      'text-info': data.status === 'In Progress',
                      'text-danger': data.status === 'Canceled',
                    ...
                    <td class="text-center">
                      <div class="dropdown">
                        <Popper :placement="rtlClass === 'rtl' ? 'bottom-start' : 'bottom-end'" offsetDistance="0"
                          class="align-middle">
                          <a href="javascript:;">
                            <svg class="w-5 h-5 opacity-70 m-auto" viewBox="0 0 24 24" fill="none"
