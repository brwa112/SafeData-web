<template>
    <div>
        <div class="panel pb-0">
            ...
            <div class="datatable">
                <vue3-datatable :rows="rows" :columns="datatable1Cols" :totalRows="rows?.length" :sortable="true"
                    sortColumn="firstName" :search="search1" skin="whitespace-nowrap table-hover"
        ...
        <div class="panel pb-0 mt-6">
            ...
            <div class="datatable">
                <vue3-datatable :rows="rows" :columns="datatable2Cols" :totalRows="rows?.length" :sortable="true"
                    sortColumn="firstName" :search="search2" skin="whitespace-nowrap table-hover" firstArrow='<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-4.5 h-4.5 rtl:rotate-180">
                    ...
                    <template #age="data">
                        <div class="w-4/5 min-w-[100px] h-2.5 bg-[#ebedf2] dark:bg-dark/40 rounded-full flex">
                            <div class="h-2.5 rounded-full rounded-bl-full text-center text-white text-xs"
                                :class="`bg-${randomColor()}`" :style="`width:${data.value.age}%`"></div>
                        </div>
                    </template>
                    <template #dob="data">
                        {{ formatDate(data.value.dob) }}
