<template>
    <div>
        <div class="flex items-center lg:justify-end justify-center flex-wrap gap-4 mb-6">
            ...
            <Link href="/apps/invoice/add" class="btn btn-secondary gap-2">
            ...
            <Link href="/apps/invoice/edit" class="btn btn-warning gap-2">
        ...
        <div class="panel">
            <div class="flex justify-between flex-wrap gap-4 px-4">
                ...
                <div class="shrink-0">
                    <img src="/public/assets/images/logo.svg" alt="" class="w-14 ltr:ml-auto rtl:mr-auto" />
                </div>
            </div>
