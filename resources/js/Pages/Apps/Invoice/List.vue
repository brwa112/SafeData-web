    ...
    <div class="panel px-0 pb-1.5 border-[#e0e6ed] dark:border-[#1b2e4b]">
        <div class="datatable invoice-table">
            ...
            <vue3-datatable ref="datatable" :rows="items" :columns="cols" :totalRows="items?.length" :hasCheckbox="true"
                :sortable="true" :search="search" skin="whitespace-nowrap table-hover"
                ...
                <template #id="data">
                    <input type="checkbox" class="form-checkbox mt-1" :id="`chk${data.value.id}`"
                        :value="`${data.value.id}`" x-model.number="selectedRows" />
                </template>
