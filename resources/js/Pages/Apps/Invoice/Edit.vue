                ...
                <div class="flex justify-between flex-wrap px-4">
                    <div class="mb-6 lg:w-1/2 w-full">
                        <div class="flex items-center text-black dark:text-white shrink-0">
                            <img src="/public/assets/images/logo.svg" alt="" class="w-14" />
                        </div>
                    ...
                    <div class="lg:w-1/2 w-full lg:max-w-fit">
                        <div class="flex items-center">
                            ...
                            <input id="number" type="text" name="inv-num" class="form-input lg:w-[250px] w-2/3"
                                placeholder="#8801" v-model="params.invoiceNo" />
                        </div>
                        <div class="flex items-center mt-4">
                            <label for="invoiceLabel" class="flex-1 ltr:mr-2 rtl:ml-2 mb-0">Invoice Label</label>
                            <input id="invoiceLabel" type="text" name="inv-label" class="form-input lg:w-[250px] w-2/3"
                                placeholder="Enter Invoice Label" v-model="params.title" />
                        </div>
                        <div class="flex items-center mt-4">
                        ...
                        <div class="lg:w-1/2 w-full ltr:lg:mr-6 rtl:lg:ml-6 mb-6">
                            ...
                            <div class="mt-4 flex items-center">
                                ...
                                <input id="reciever-name" type="text" name="reciever-name" class="form-input flex-1"
                                    v-model="params.to.name" placeholder="Enter Name" />
                            </div>
                            <div class="mt-4 flex items-center">
                                ...
                                <input id="reciever-email" type="email" name="reciever-email" class="form-input flex-1"
                                    v-model="params.to.email" placeholder="Enter Email" />
                            </div>
                            <div class="mt-4 flex items-center">
                                ...
                                <input id="reciever-address" type="text" name="reciever-address" class="form-input flex-1"
                                    v-model="params.to.address" placeholder="Enter Address" />
                            </div>
                            <div class="mt-4 flex items-center">
                                ...
                                <input id="reciever-number" type="text" name="reciever-number" class="form-input flex-1"
                                    v-model="params.to.phone" placeholder="Enter Phone number" />
                            </div>
                        </div>
                        <div class="lg:w-1/2 w-full">
                            ...
                            <div class="flex items-center mt-4">
                                ...
                                <input id="acno" type="text" name="acno" class="form-input flex-1"
                                    v-model="params.bankInfo.no" placeholder="Enter Account Number" />
                            </div>
                            <div class="flex items-center mt-4">
                                ...
                                <input id="bank-name" type="text" name="bank-name" class="form-input flex-1"
                                    v-model="params.bankInfo.name" placeholder="Enter Bank Name" />
                            </div>
                            <div class="flex items-center mt-4">
                                ...
                                <input id="swift-code" type="text" name="swift-code" class="form-input flex-1"
                                    v-model="params.bankInfo.swiftCode" placeholder="Enter SWIFT Number" />
                            </div>
                            <div class="flex items-center mt-4">
                                ...
                                <input id="iban-code" type="text" name="iban-code" class="form-input flex-1"
                                    v-model="params.bankInfo.ibanNo" placeholder="Enter IBAN Number" />
                            </div>
                            <div class="flex items-center mt-4">
                                    ...
                                    <tr class="align-top">
                                        <td>
                                            <input type="text" class="form-input min-w-[200px]"
                                                placeholder="Enter Item Name" v-model="item.title" />
                    ...
                    <div class="mt-4">
                        <div class="grid sm:grid-cols-2 grid-cols-1 gap-4">
                            <div>
                                ...
                                <input v-model="tax" id="tax" type="number" name="tax" class="form-input"
                                    placeholder="Tax" />
                            </div>
                            <div>
                                <label for="discount">Discount(%) </label>
                                <input id="discount" type="number" name="discount" class="form-input" placeholder="Discount"
                                    v-model="discount" />
                            </div>
                        </div>
                    </div>
                    <div class="mt-4">
                        <div>
                            ...
                            <input id="shipping-charge" type="number" name="shipping-charge" class="form-input"
                                placeholder="Shipping Charge" v-model="shippingCharge" />
                        </div>
                    </div>
                    <div class="mt-4">
...
const addItem = () => {
    ...
    if (items.value && items.value.length) {
        maxId = items.value.reduce((max, character) => (character.id > max ? character.id : max), items.value[0].id);
    }
    items.value.push({
        id: maxId + 1,
        title: '',
