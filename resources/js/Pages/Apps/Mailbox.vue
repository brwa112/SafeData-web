                        ...
                        <div class="space-y-1">
                            ...
                            <disclosure as="div" v-slot="{ open }">
                                <disclosure-button
                                    ...
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" :class="{ 'rotate-180': open }">
                                                    ...
                                                    <ul @click="close()">
                                                        <li>
                                                            <a href="javascript:;" @click="setGroup('personal')">
                                                                <div
                                                                    class="w-2 h-2 rounded-full bg-primary ltr:mr-3 rtl:ml-3">
                                                                </div>
                                                                Personal
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <a href="javascript:;" @click="setGroup('work')">
                                                                <div
                                                                    class="w-2 h-2 rounded-full bg-warning ltr:mr-3 rtl:ml-3">
                                                                </div>
                                                                Work
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <a href="javascript:;" @click="setGroup('social')">
                                                                <div
                                                                    class="w-2 h-2 rounded-full bg-success ltr:mr-3 rtl:ml-3">
                                                                </div>
                                                                Social
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <a href="javascript:;" @click="setGroup('private')">
                                                                <div
                                                                    class="w-2 h-2 rounded-full bg-danger ltr:mr-3 rtl:ml-3">
                                                                </div>
                                                                Private
                                                            </a>
                                                        </li>
