<template>
    <div>
        <div class="flex gap-5 relative sm:h-[calc(100vh_-_150px)] h-full sm:min-h-0"
            ...
            <div class="panel p-4 flex-none max-w-xs w-full absolute xl:relative z-10 space-y-4 h-full hidden xl:block overflow-hidden"
                :class="isShowChatMenu && '!block !overflow-y-auto'">
                <div class="flex justify-between items-center">
                    <div class="flex items-center">
                        <div class="flex-none"><img src="/public/assets/images/profile-34.jpeg"
                                ...
                                <div class="flex-1">
                                    <div class="flex items-center">
                                        ...
                                        <div class="mx-3 ltr:text-left rtl:text-right">
                                            ...
                                            <p class="text-xs text-white-dark truncate max-w-[185px]">{{ person.preview }}
                                            </p>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="panel p-0 flex-1">
                <template v-if="!isShowUserChat">
                    <div class="flex items-center justify-center h-full relative p-4">
                        <button type="button" class="xl:hidden absolute top-4 ltr:left-4 rtl:right-4 hover:text-primary"
                            ...
                            <div class="space-y-5 p-4 sm:pb-0 pb-[68px] sm:min-h-[300px] min-h-[400px]">
                                <div class="block m-6 mt-0">
                                    <h4 class="text-xs text-center border-b border-[#f4f4f4] dark:border-gray-800 relative">
                                        <span class="relative top-2 px-3 bg-white dark:bg-[#0e1726]">{{ 'Today, ' +
                                            selectedUser.time }}</span>
                                    </h4>
                                </div>
                                        ...
                                        <div class="flex items-start gap-3"
                                            ...
                                            <div class="space-y-2">
                                                <div class="flex items-center gap-3">
                                                    <div class="dark:bg-gray-800 p-4 py-2 rounded-md bg-black/10" :class="message.fromUserId == selectedUser.userId
                            ...
                            <div class="sm:flex w-full space-x-3 rtl:space-x-reverse items-center">
                                <div class="relative flex-1">
                                    <input
                                        ...
                                        placeholder="Type a message" v-model="textMessage"
                                    ...
                                    <button type="button"
                                        ...
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                            ...
                                            <path
                                                ...
                                                stroke="currentColor" stroke-width="1.5" />
                                            <path opacity="0.5" d="M13.5 8L17 8" stroke="currentColor" stroke-width="1.5"
                                                stroke-linecap="round" />
                                            <path opacity="0.5" d="M13.5 11L17 11" stroke="currentColor" stroke-width="1.5"
                                                stroke-linecap="round" />
