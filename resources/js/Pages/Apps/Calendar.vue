<template>
    <div>
        ...
        <TransitionRoot appear :show="isAddEventModal" as="template">
            <Dialog as="div" @close="isAddEventModal = false" class="relative z-50">
                                ...
                                <div class="p-5">
                                    <form @submit.prevent="saveEvent">
                                        ...
                                        <div class="mb-5">
                                            ...
                                            <flat-pickr v-model="params.start" class="form-input"
                                                @change="startDateChange($event)" :min="minStartDate" :config="basic"
                                                placeholder="2050-01-01"></flat-pickr>
                                            <div class="text-danger mt-2" id="startDateErr"></div>
                                        </div>
                                        <div class="mb-5">
                                            <label for="dateEnd">To :</label>
                                            <flat-pickr v-model="params.end" class="form-input" :min="minEndDate"
                                                :config="basic" placeholder="2050-01-01"></flat-pickr>
...
const basic = ref({
    dateFormat: 'Y-m-d',
    position: rtlClass === 'rtl' ? 'auto right' : 'auto left',
});
