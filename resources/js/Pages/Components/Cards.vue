                    ...
                    <div
                        ...
                        <div class="py-7 px-6">
                            <div class="-mt-7 mb-7 -mx-6 rounded-tl rounded-tr h-[215px] overflow-hidden">
                                <img src="/public/assets/images/profile-28.jpeg" alt=""
                                    class="w-full h-full object-cover" />
                            </div>
                            <h5 class="text-[#3b3f5c] text-xl font-semibold mb-4 dark:text-white-light">CLI Based</h5>
                            <p class="text-white-dark">Etiam sed augue ac justo tincidunt posuere. Vivamus euismod eros, nec
                                risus malesuada.</p>
                    ...
                    <div
                        ...
                        <div class="p-5 flex items-center flex-col sm:flex-row">
                            ...
                            <div class="flex-1 ltr:sm:pl-5 rtl:sm:pr-5 text-center sm:text-left">
                                <h5 class="text-[#3b3f5c] text-[15px] font-semibold mb-2 dark:text-white-light">Luke Ivory
                                </h5>
                                ...
                                <p class="font-semibold text-white-dark mt-4 sm:mt-8">
                                    Maecenas nec mi vel lacus condimentum rhoncus dignissim egestas orci. Integer blandit
                                    porta placerat. Vestibulum in
                                    ultricies.
                                </p>
                            </div>
                        </div>
                ...
                <div class="mb-5 flex items-center justify-center">
                    <div
                        ...
                        <div class="text-[#515365] dark:text-white-light">
                            ...
                            <div class="flex">
                                <div class="flex-1">
                                    <h5 class="text-[#3b3f5c] text-[15px] font-bold mb-1.5 dark:text-white-light">Luke Ivory
                                    </h5>
                ...
                <div class="mb-5 flex items-center justify-center">
                    <div
                        ...
                        <div class="py-7 px-6">
                            ...
                            <h5 class="text-[#3b3f5c] text-[15px] font-bold mb-4 dark:text-white-light">How to Start a Blog
                                in 5 Easy Steps.</h5>
