            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div class="panel">
                    ...
                    <swiper :modules="[Navigation, Pagination]"
                        ...
                        :pagination="{ clickable: true }" class="max-w-3xl mx-auto mb-5" id="slider1" :dir="rtlClass"
                ...
                <div class="panel">
                    ...
                    <swiper :modules="[Navigation, Autoplay]"
                        ...
                        :autoplay="{ delay: 2000 }" class="max-w-3xl mx-auto mb-5" id="slider2" :dir="rtlClass"
                        :key="rtlClass === 'rtl' ? 'true' : 'false'">
                        <template v-for="(item, i) in items" :key="i">
                            <swiper-slide>
                                <img :src="`/assets/images/${item}`" class="w-full max-h-80 object-cover" alt="" />
                ...
                <div class="panel">
                    ...
                    <swiper :modules="[Pagination, Autoplay]" :direction="'vertical'" :pagination="{ clickable: true }"
                        :autoplay="{ delay: 2000 }" class="max-w-3xl mx-auto mb-5" id="slider3">
                        <template v-for="(item, i) in items" :key="i">
                            <swiper-slide>
                                ...
                                <div
                                    ...
                                    <div class="sm:text-xl text-base font-medium">Lorem Ipsum is simply dummy text of the
                                        printing.</div>
                                </div>
                            </swiper-slide>
                        </template>
                ...
                <div class="panel">
                    ...
                    <swiper :modules="[Navigation, Pagination]" slidesPerView="auto" :spaceBetween="30" :loop="true"
                        :navigation="{ nextEl: '.swiper-button-next-ex4', prevEl: '.swiper-button-prev-ex4' }"
                        :pagination="{ clickable: true, type: 'fraction' }" class="max-w-3xl mx-auto mb-5" id="slider4"
                        :dir="rtlClass" :key="rtlClass === 'rtl' ? 'true' : 'false'">
                        <swiper-slide>
                            <img src="/public/assets/images/carousel1.jpeg" class="w-full" alt="" />
                            <div
                                ...
                                <div class="mb-4 sm:text-base font-medium">Lorem Ipsum is simply dummy text of the printing.
                                </div>
                            </div>
                        </swiper-slide>
                        <swiper-slide>
                            <img src="/public/assets/images/carousel2.jpeg" class="w-full" alt="" />
                            <div
                                class="absolute z-[999] text-white bottom-8 left-1/2 w-full -translate-x-1/2 text-center sm:px-0 px-11">
                        ...
                        <swiper-slide>
                            <img src="/public/assets/images/carousel3.jpeg" class="w-full" alt="" />
                            <div
                                class="absolute z-[999] text-white bottom-8 left-1/2 w-full -translate-x-1/2 text-center sm:px-0 px-11">
                ...
                <div class="panel lg:col-span-2">
                    ...
                    <swiper :modules="[Navigation, Pagination]"
                        ...
                        }" id="slider5" :dir="rtlClass" :key="rtlClass === 'rtl' ? 'true' : 'false'">
                        <template v-for="(item, i) in items" :key="i">
                            <swiper-slide>
                                <img :src="`/assets/images/${item}`" class="w-full" alt="" />
                            </swiper-slide>
