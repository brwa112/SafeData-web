    ...
    <div class="pt-5 space-y-8">
      <div class="panel p-3 flex items-center text-primary overflow-x-auto whitespace-nowrap">
        ...
        <span class="ltr:mr-3 rtl:ml-3">Documentation: </span><a
          href="https://www.npmjs.com/package/vue-height-collapsible" target="_blank"
          class="block hover:underline">https://www.npmjs.com/package/vue-height-collapsible</a>
      </div>
      <!-- basic -->
                ...
                <vue-collapsible :isOpen="accordians1 === 3">
                  <div class="p-4 text-[13px] border-t border-[#d3d3d3] dark:border-[#1b2e4b]">
                    <p>
                      ...
                      wolf moon officia
                      aute, non cupidatat skateboard dolor brunch. Food truck quinoa nesciunt laborum eiusmod. Brunch 3
                      wolf moon tempor,
                ...
                <button type="button" class="p-4 w-full flex items-center text-white-dark dark:bg-[#1b2e4b]"
                  ...
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <path
                      ...
                      stroke="currentColor" stroke-width="1.5" stroke-linecap="round" />
                    <path opacity="0.5" d="M21 7.5L12 12M12 12L3 7.5M12 12V21.5" stroke="currentColor" stroke-width="1.5"
...
const accordians2 = ref(1);
const accordians3 = ref(1);
const accordians4 = ref(1);
</script>
