            ...
            <div class="pt-5 space-y-8">
                <div class="panel p-3 flex items-center text-primary overflow-x-auto whitespace-nowrap">
                    ...
                    <span class="ltr:mr-3 rtl:ml-3">Documentation: </span><a
                        href="https://www.npmjs.com/package/vue-easy-lightbox" target="_blank"
                        class="block hover:underline">https://www.npmjs.com/package/vue-easy-lightbox</a>
                </div>
                    ...
                    <div class="mb-5">
                        <div class="flex mb-5">
                            <div class="ltr:mr-4 rtl:ml-4">
                                <input v-model="allcontrols" :value="true" type="radio" @change="bindFancybox()"
                                    class="form-radio mt-1.5" checked />
                            </div>
                            <div class="flex-1">
                                <h4 class="font-semibold text-lg text-primary">All controls</h4>
                                <p class="media-text">Caption, slideshow, thumbnails and fullscreen buttons, tap to toggle
                                    controls</p>
                            </div>
                        </div>
                        <div class="flex">
                            <div class="ltr:mr-4 rtl:ml-4">
                                <input v-model="allcontrols" :value="false" type="radio" @change="bindFancybox()"
                                    class="form-radio mt-1.5" />
                            </div>
                            <div class="flex-1">
                                <h4 class="font-semibold text-lg text-primary">Minimal</h4>
                                <p class="media-text">No caption, no slideshow, no thumbnails, no fullscreen, tap to close
                                </p>
                            </div>
                        </div>
                        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 mt-10">
                            <template v-for="(item, i) in items" :key="i">
                                <a href="javascript:;" :class="{ 'md:row-span-2 md:col-span-2': i == 3 }" @click="
                                    index = i;
                                visible = true;
                                ">
                            ...
                            <vue-easy-lightbox :visible="visible" :imgs="items" :index="index" scrollDisabled moveDisabled
                                loop :class="{ minimal: !allcontrols }" @hide="
                                    index = null;
                                visible = false;
                                ">
                            </vue-easy-lightbox>
