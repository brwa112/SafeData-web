    ...
    <div>
        ...
        <div class="pt-5 space-y-8">
            <div class="panel p-3 flex items-center text-primary overflow-x-auto whitespace-nowrap">
                ...
                <span class="ltr:mr-3 rtl:ml-3">Documentation: </span><a href="https://www.npmjs.com/package/vue-countup-v3"
                    target="_blank" class="block hover:underline">https://www.npmjs.com/package/vue-countup-v3</a>
            </div>
                    ...
                    <div class="mb-5 grid grid-cols-3 justify-items-center gap-3 max-w-[900px] mx-auto">
                        <div>
                            <div
                                ...
                                <count-up class="text-primary text-xl sm:text-3xl text-center" :startVal="0" :end-val="710"
                                    :duration="7"></count-up>
                            </div>
                            <h4
                        ...
                        <div>
                            <div
                                class="w-[70px] h-[70px] sm:w-[100px] sm:h-[100px] shadow-[1px_2px_12px_0_rgba(31,45,61,0.10)] rounded border border-[#e0e6ed] dark:border-[#1b2e4b] flex justify-center flex-col">
                                <count-up class="text-primary text-xl sm:text-3xl text-center" :startVal="0" :end-val="915"
                                    :duration="7"></count-up>
                            </div>
                            <h4
                                class="text-[#3b3f5c] text-xs sm:text-[15px] mt-4 text-center dark:text-white-dark font-semibold">
                        ...
                        <div>
                            <div
                                class="w-[70px] h-[70px] sm:w-[100px] sm:h-[100px] shadow-[1px_2px_12px_0_rgba(31,45,61,0.10)] rounded border border-[#e0e6ed] dark:border-[#1b2e4b] flex justify-center flex-col">
                                <count-up class="text-primary text-xl sm:text-3xl text-center" :startVal="0" :end-val="580"
                                    :duration="7"></count-up>
                            </div>
                            <h4
                                class="text-[#3b3f5c] text-xs sm:text-[15px] mt-4 text-center dark:text-white-dark font-semibold">
                    ...
                    <div class="mb-5 grid grid-cols-3 justify-items-center gap-3 max-w-[900px] mx-auto">
                        <div>
                            <div
                                ...
                                <count-up class="text-primary text-xl sm:text-3xl text-center" :startVal="0" :end-val="105"
                                    :duration="7"></count-up>
                            </div>
                            <h4
                                class="text-[#3b3f5c] text-xs sm:text-[15px] mt-4 text-center dark:text-white-dark font-semibold">
                        ...
                        <div>
                            <div
                                class="w-[70px] h-[70px] sm:w-[100px] sm:h-[100px] shadow-[1px_2px_12px_0_rgba(31,45,61,0.10)] rounded-full border border-[#e0e6ed] dark:border-[#1b2e4b] flex justify-center flex-col">
                                <count-up class="text-primary text-xl sm:text-3xl text-center" :startVal="0" :end-val="300"
                                    :duration="7"></count-up>
                            </div>
                            <h4
                                class="text-[#3b3f5c] text-xs sm:text-[15px] mt-4 text-center dark:text-white-dark font-semibold">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    ...
                                    <path opacity="0.5"
                                        ...
                                        stroke="currentColor" stroke-width="1.5" stroke-linecap="round" />
                                    <path d="M12 22V16M12 22L14 20M12 22L10 20" stroke="currentColor" stroke-width="1.5"
                        ...
                        <div>
                            <div
                                class="w-[70px] h-[70px] sm:w-[100px] sm:h-[100px] shadow-[1px_2px_12px_0_rgba(31,45,61,0.10)] rounded-full border border-[#e0e6ed] dark:border-[#1b2e4b] flex justify-center flex-col">
                                <count-up class="text-primary text-xl sm:text-3xl text-center" :startVal="0" :end-val="58"
                                    :duration="7"></count-up>
                            </div>
                            <h4
                                class="text-[#3b3f5c] text-xs sm:text-[15px] mt-4 text-center dark:text-white-dark font-semibold">
