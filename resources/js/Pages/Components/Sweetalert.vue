    ...
    <div>
        ...
        <div class="pt-5 space-y-8 sweet-alerts">
            <div class="panel p-3 flex items-center text-primary overflow-x-auto whitespace-nowrap">
                ...
                <span class="ltr:mr-3 rtl:ml-3">Documentation: </span><a href="https://www.npmjs.com/package/sweetalert2"
                    target="_blank" class="block hover:underline">https://www.npmjs.com/package/sweetalert2</a>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div class="mb-5">
                        ...
                        <div class="fixed inset-0 bg-[black]/60 z-[999] transition-all duration-300 px-4 hidden">
                            <div
                                ...
                                <h3 class="text-[#3b3f5c] dark:text-white-light text-2xl font-bold mb-5">Custom animation
                                    with Animate.css</h3>
                ...
                <div class="panel">
                    ...
                    <div class="mb-5">
                        <div class="flex items-center justify-center">
                            <button type="button" class="btn btn-secondary" @click="showAlert(8)">Message with custom
                                image</button>
                        </div>
                    </div>
                ...
                <div class="panel">
                    <div class="flex items-center justify-between mb-5">
                        <h5 class="font-semibold text-lg dark:text-white-light">A message with custom width, padding and
                            background</h5>
                    </div>
                    <div class="mb-5">
                        <div class="flex items-center justify-center">
...
const showAlert = async (type) => {
    if (type === 1) {
        ...
        Swal.fire({
            ...
            imageUrl: '/public/assets/images/custom-swal.svg',
            imageWidth: 224,
            imageHeight: 'auto',
        ...
        Swal.fire({
            ...
            background: '#fff url(' + '/public/assets/images/sweet-bg.jpg' + ') no-repeat 100% 100%',
        });
    } else if (type === 13) {
        Swal.fire({
            icon: 'error',
