        ...
        <div class="pt-5 grid grid-cols-1 xl:grid-cols-2 gap-6">
                ...
                <div class="mb-5">
                    <div class="flex">
                        <div class="ltr:mr-4 rtl:ml-4">
                            <img src="/public/assets/images/profile-5.jpeg" alt="" class="w-16 h-16 rounded" />
                        </div>
                        <div class="flex-1">
                            <h4 class="font-semibold text-lg mb-2 text-primary">Heading</h4>
                            <p class="media-text">
                                Fusce condimentum cursus mauris et ornare. Mauris fermentum mi id sollicitudin viverra.
                    ...
                    <div class="flex items-start">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="media-text">
                                Fusce condimentum cursus mauris et ornare. Mauris fermentum mi id sollicitudin viverra.
                                Aenean dignissim sed ante eget dapibus.
                                Sed dapibus nulla elementum, rutrum neque eu, gravida neque. Fusce condimentum cursus mauris
                                et ornare. Mauris fermentum mi id
                                sollicitudin viverra. Aenean dignissim sed ante eget dapibus. Sed dapibus nulla elementum,
            ...
            <div class="panel">
                ...
                <div class="mb-5">
                    <div class="flex mb-5">
                        <div class="ltr:mr-4 rtl:ml-4">
                            <img src="/public/assets/images/profile-5.jpeg" alt="" class="w-14 h-14 rounded" />
                        </div>
                        <div class="flex-1">
                            <h4 class="font-semibold text-lg mb-2 text-primary">Heading</h4>
                            <p class="media-text">
                        ...
                        <div class="flex-1">
                            ...
                            <div class="flex">
                                ...
                                <div class="flex-1">
                                    <h4 class="font-semibold text-lg mb-2 text-primary">Heading</h4>
                                    <p class="media-text">
                                        Fusce condimentum cursus mauris et ornare. Mauris fermentum mi id sollicitudin
                    ...
                    <div class="flex">
                        ...
                        <div class="flex-1">
                            <div class="flex justify-between mb-2">
                                ...
                                <div class="dropdown">
                                    <Popper :placement="rtlClass === 'rtl' ? 'bottom-start' : 'bottom-end'"
