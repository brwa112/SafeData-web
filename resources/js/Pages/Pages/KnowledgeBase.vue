            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-5">
                <div
                    ...
                    <div
                        ...
                        <img src="/public/assets/images/lightbox1.jpg" alt="..." />
                    </div>
                    <h5 class="text-xl mb-5">Excessive sugar is harmful</h5>
                    <div class="flex">
                        <div class="rounded-full overflow-hidden ltr:mr-4 rtl:ml-4">
                            <img src="/public/assets/images/profile-1.jpeg" class="w-11 h-11 object-cover" alt="profile1" />
                        </div>
                        <div class="flex-1">
                            <h4>Alma Clark</h4>
                            <p>06 May</p>
                ...
                <div
                    ...
                    <div
                        class="rounded-md overflow-hidden mb-5 shadow-[0_6px_10px_0_rgba(0,0,0,0.14),_0_1px_18px_0_rgba(0,0,0,0.12),_0_3px_5px_-1px_rgba(0,0,0,0.20)]">
                        <img src="/public/assets/images/lightbox2.jpeg" alt="..." />
                    </div>
                    <h5 class="text-xl mb-5">Creative Photography</h5>
                    <div class="flex">
                        <div class="rounded-full overflow-hidden ltr:mr-4 rtl:ml-4">
                            <img src="/public/assets/images/profile-2.jpeg" class="w-11 h-11 object-cover" alt="profile2" />
                        </div>
                        <div class="flex-1">
                            <h4>Alma Clark</h4>
                            <p>06 May</p>
                ...
                <div
                    ...
                    <div
                        class="rounded-md overflow-hidden mb-5 shadow-[0_6px_10px_0_rgba(0,0,0,0.14),_0_1px_18px_0_rgba(0,0,0,0.12),_0_3px_5px_-1px_rgba(0,0,0,0.20)]">
                        <img src="/public/assets/images/lightbox3.jpeg" alt="..." />
                    </div>
                    <h5 class="text-xl mb-5">Plan your next trip</h5>
                    <div class="flex">
                        <div class="rounded-full overflow-hidden ltr:mr-4 rtl:ml-4">
                            <img src="/public/assets/images/profile-3.jpeg" class="w-11 h-11 object-cover" alt="profile3" />
                        </div>
                        <div class="flex-1">
                            <h4>Alma Clark</h4>
                            <p>06 May</p>
                ...
                <div
                    ...
                    <div
                        class="rounded-md overflow-hidden mb-5 shadow-[0_6px_10px_0_rgba(0,0,0,0.14),_0_1px_18px_0_rgba(0,0,0,0.12),_0_3px_5px_-1px_rgba(0,0,0,0.20)]">
                        <img src="/public/assets/images/lightbox4.jpeg" alt="..." />
                    </div>
                    <h5 class="text-xl mb-5">My latest Vlog</h5>
                    <div class="flex">
                        <div class="rounded-full overflow-hidden ltr:mr-4 rtl:ml-4">
                            <img src="/public/assets/images/profile-4.jpeg" class="w-11 h-11 object-cover" alt="profile4" />
                        </div>
                        <div class="flex-1">
                            <h4>Alma Clark</h4>
                            <p>06 May</p>
