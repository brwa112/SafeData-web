        ...
        <div class="shadow-sm">
            <div class="relative bg-white flex w-full items-center px-5 py-3 dark:bg-[#0e1726]">
                <div class="horizontal-logo flex lg:hidden justify-between items-center ltr:mr-2 rtl:ml-2">
                    ...
                    <button type="button"
                        class="collapse-icon flex-none duration-200 dark:text-[#d0d2d6] hover:text-primary dark:hover:text-primary flex lg:hidden ms-4 p-2 rounded-full bg-white-light/40 dark:bg-dark/40 hover:bg-white-light/90 dark:hover:bg-dark/60"
                        @click="toggleSidebar">
                ...
                <div
                    class="sm:flex-1 ltr:sm:ml-0 ltr:ml-auto sm:rtl:mr-0 rtl:mr-auto flex items-center space-x-4 lg:space-x-8 rtl:space-x-reverse dark:text-[#d0d2d6]">
                    <div class="sm:me-auto">
                        <form
                            class="sm:relative absolute inset-x-0 sm:top-0 top-1/2 sm:translate-y-0 -translate-y-1/2 mx-4 sm:mx-0 z-40 sm:block hidden"
                            :class="{ '!block': search }" @submit.prevent="search = false">
                            <div class="relative">
                                <input type="text"
                                    class="form-input rounded-none text-base pe-9 py-5 sm:py-0 bg-white dark:bg-text-gray-800 sm:bg-transparent dark:sm:bg-transparent focus:right-0 focus:outline-none border-transparent dark:border-transparent focus:border-1 focus:border-transparent dark:focus:border-transparent"
                                    placeholder="Search..." />
                                <button type="button" @click="search = !search"
                                    class="absolute size-5 top-1/2 -translate-y-1/2 end-0 appearance-none peer-focus:text-primary">
                    ...
                    <div class="flex items-center gap-3">
                        <!-- Language -->
                        <div class="relative z-30 ms-auto">
                            <Menu as="div" class="relative inline-block text-left">
                                <div>
                                    <MenuButton v-slot="{ open }"
                                        class="flex items-center gap-4 w-full text-dark-blue/80 bg-white dark:bg-transparent font-bold text-sm p-2.5 px-3.5 rounded-xl">
                                        <template v-for="language in store.languageList" :key="language.code">
                                            <div v-if="language.code == lang"
                                                class="flex items-center gap-2.5 size-[1.125rem] lg:size-full">
                                                <img :src="`/assets/images/langs/${lang}.png`" alt="lang"
                                                    class="size-[1.125rem]">
                                                <span class="rtl:mb-0.5 ltr:text-[.8rem] hidden lg:block">
                                                    {{ $t(`auth.${language.name}`) }}
                                                </span>
                                            </div>
                                        </template>
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                            class="size-3.5 text-dark-blue duration-200 hidden lg:block"
                                            :class="{ 'rotate-180': open }" viewBox="0 0 18 9">
                                            <path fill="none"
                                ...
                                <transition enter-active-class="transition duration-200 ease-out"
                                    enter-from-class="transform opacity-0" enter-to-class="transform opacity-200"
                                    leave-active-class="transition duration-200 ease-in"
                                    leave-from-class="transform opacity-100" leave-to-class="transform opacity-0">
                                    <MenuItems
                                        class="absolute end-0 z-50 mt-2 w-full min-w-36 origin-top-right border border-gray-100 dark:border-gray-700 divide-y divide-gray-100 dark:divide-gray-700 px-2 py-1 rounded-lg bg-white dark:bg-gray-900 shadow-sm ring-0 focus:outline-none">
                        ...
                        <!-- Mode Dark/Light -->
                        <div class="inline relative z-30">
                            <label class="w-12 h-6 mt-2 relative">
                                <input type="checkbox" @click="toggleTheme" :checked="store.theme === 'dark'"
                                    class="custom_switch absolute w-full h-full opacity-0 z-10 cursor-pointer peer"
                                    id="custom_switch_checkbox2" />
                                <span for="custom_switch_checkbox2"
                                    class="outline_checkbox bg-icon border-2 border-[#ebedf2] dark:border-white-dark block h-full rounded-full before:absolute before:left-1 before:bg-[#ebedf2] dark:before:bg-white-dark before:bottom-1 before:w-4 before:h-4 before:rounded-full before:bg-[url('/public/assets/images/sun.svg')] before:bg-no-repeat before:bg-center peer-checked:before:left-7 peer-checked:before:bg-[url('/public/assets/images/moon.svg')] peer-checked:border-primary peer-checked:before:bg-primary before:transition-all before:duration-300"></span>
                            </label>
                        </div>
                    </div>

                    <div class="h-6 w-0.5 bg-gray-300 dark:bg-gray-700 rounded-full"></div>

                    <div class="flex items-center justify-center">
                        <button type="button" @click="openLogout"
                            class="text-danger !p-3 bg-danger/10 dark:bg-danger/20 rounded-full rtl:rotate-180">
                            <svg class="size-5 rotate-90" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="M17 9.00195C19.175 9.01406 20.3529 9.11051 21.1213 9.8789C22 10.7576 22 12.1718 22 15.0002V16.0002C22 18.8286 22 20.2429 21.1213 21.1215C20.2426 22.0002 18.8284 22.0002 16 22.0002H8C5.17157 22.0002 3.75736 22.0002 2.87868 21.1215C2 20.2429 2 18.8286 2 16.0002L2 15.0002C2 12.1718 2 10.7576 2.87868 9.87889C3.64706 9.11051 4.82497 9.01406 7 9.00195"
                                    stroke="currentColor" stroke-width="1.5" stroke-linecap="round" />
                                <path opacity="0.5" d="M12 15L12 2M12 2L15 5.5M12 2L9 5.5" stroke="currentColor"
                                ...
                                <div class="flex min-h-full items-center justify-center p-4 text-center">
                                    <TransitionChild as="template" enter="duration-300 ease-out"
                                        ...
                                        <DialogPanel
                                            ...
                                            <DialogTitle as="h3" class="text-lg font-medium leading-6 text-gray-900 dark:text-info-light">
                                                Logout
                                            </DialogTitle>
                                            <div class="mt-2">
                    ...
                    <Link :href="route('logout')"
                        class="text-danger !p-3 bg-danger/10 dark:bg-danger/20 rounded-full rtl:rotate-180 hidden">
                    <svg class="size-5 rotate-90" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                            d="M17 9.00195C19.175 9.01406 20.3529 9.11051 21.1213 9.8789C22 10.7576 22 12.1718 22 15.0002V16.0002C22 18.8286 22 20.2429 21.1213 21.1215C20.2426 22.0002 18.8284 22.0002 16 22.0002H8C5.17157 22.0002 3.75736 22.0002 2.87868 21.1215C2 20.2429 2 18.8286 2 16.0002L2 15.0002C2 12.1718 2 10.7576 2.87868 9.87889C3.64706 9.11051 4.82497 9.01406 7 9.00195"
                            stroke="currentColor" stroke-width="1.5" stroke-linecap="round" />
                        <path opacity="0.5" d="M12 15L12 2M12 2L15 5.5M12 2L9 5.5" stroke="currentColor"
            ...
            <ul
                ...
                <li class="menu nav-item relative">
                    <a href="javascript:;" class="nav-link">
                        <div class="flex items-center">
                            ...
                            <span class="px-2">components</span>
                        </div>
                        <div class="right_arrow">
                            <svg class="w-4 h-4 rotate-90" width="16" height="16" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                    ...
                    <ul class="sub-menu">
                        ...
                        <li class="relative">
                            ...
                            <ul
                                ...
                                <li>
                                    <Link href="/datatables/columns-filter">columns_filter</Link>
                                </li>
                                <li>
                                ...
                                <li>
                                    <Link href="/datatables/alt-pagination">alt._pagination</Link>
                                </li>
                                <li>
                                ...
                                <li>
                                    <Link href="/datatables/sticky-header">sticky_header</Link>
                                </li>
                                <li>
                                    <Link href="/datatables/clone-header">clone_header</Link>
                                </li>
                                <li>
                ...
                <li class="menu nav-item relative">
                    ...
                    <ul class="sub-menu">
                        ...
                        <li>
                            <Link href="/forms/checkbox-radio">checkbox_&_radio</Link>
                        </li>
                        <li>
                        ...
                        <li>
                            <Link href="/forms/date-picker">date_&_range_picker</Link>
                        </li>
                        <li>
                    ...
                    <ul class="sub-menu">
                        <li class="relative">
                            ...
                            <ul
                                ...
                                <li>
                                    <Link href="/users/user-account-settings">account_settings
                                    </Link>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li>
                            <Link href="/pages/contact-us" target="_blank">contact_form</Link>
                        </li>
                        <li>
                            <Link href="/pages/faq">FAQ</Link>
                        </li>
                        <li>
                            <Link href="/pages/coming-soon" target="_blank">coming_soon</Link>
                        </li>
                        <li>
                            <Link href="/pages/maintenence" target="_blank">maintenence</Link>
                        </li>
                        <li class="relative">
                            ...
                            <ul
                                class="rounded absolute top-0 ltr:left-[95%] rtl:right-[95%] min-w-[180px] bg-white z-[10] text-dark dark:text-white-dark dark:bg-[#1b2e4b] shadow p-0 py-2 hidden">
                                <li>
                                    <Link href="/pages/error404" target="_blank">404</Link>
                                </li>
                                <li>
                                    <Link href="/pages/error500" target="_blank">500</Link>
                                </li>
                                <li>
                                    <Link href="/pages/error503" target="_blank">503</Link>
                                </li>
                            </ul>
                        </li>
                        <li class="relative">
                            ...
                            <ul
                                class="rounded absolute top-0 ltr:left-[95%] rtl:right-[95%] min-w-[180px] bg-white z-[10] text-dark dark:text-white-dark dark:bg-[#1b2e4b] shadow p-0 py-2 hidden">
                                <li>
                                    <Link href="/auth/cover-login" target="_blank">login_cover
                                    </Link>
                                </li>
                                <li>
                                    <Link href="/auth/boxed-signin" target="_blank">login_boxed
                                    </Link>
                                </li>
                            </ul>
                        </li>
                        <li class="relative">
                            ...
                            <ul
                                class="rounded absolute top-0 ltr:left-[95%] rtl:right-[95%] min-w-[180px] bg-white z-[10] text-dark dark:text-white-dark dark:bg-[#1b2e4b] shadow p-0 py-2 hidden">
                                <li>
                                    <Link href="/auth/cover-register" target="_blank">register_cover
                                    </Link>
                                </li>
                                <li>
                                    <Link href="/auth/boxed-signup" target="_blank">register_boxed
                                    </Link>
                                </li>
                            </ul>
                        </li>
                        <li class="relative">
                            <a href="javascript:;">password_recovery
                                <div class="ltr:ml-auto rtl:mr-auto rtl:rotate-180">
                                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path d="M9 5L15 12L9 19" stroke="currentColor" stroke-width="1.5"
                            ...
                            <ul
                                class="rounded absolute top-0 ltr:left-[95%] rtl:right-[95%] min-w-[180px] bg-white z-[10] text-dark dark:text-white-dark dark:bg-[#1b2e4b] shadow p-0 py-2 hidden">
                                <li>
                                    <Link href="/auth/cover-password-reset" target="_blank">recover_id_cover
                                    </Link>
                                </li>
                                <li>
                                    <Link href="/auth/boxed-password-reset" target="_blank">recover_id_boxed
                                    </Link>
                                </li>
                            </ul>
                        </li>
                        <li class="relative">
                            ...
                            <ul
                                class="rounded absolute top-0 ltr:left-[95%] rtl:right-[95%] min-w-[180px] bg-white z-[10] text-dark dark:text-white-dark dark:bg-[#1b2e4b] shadow p-0 py-2 hidden">
                                <li>
                                    <Link href="/auth/cover-lockscreen" target="_blank">unlock_cover
                                    </Link>
                                </li>
                                <li>
                                    <Link href="/auth/boxed-lockscreen" target="_blank">unlock_boxed
                                    </Link>
                                </li>
                            </ul>
                        </li>
...
const toggleTheme = () => {
    ...
    settings.toggleTheme(store.theme);
    emits('checkSettings');
};
