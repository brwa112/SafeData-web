            ...
            <div class="bg-white dark:bg-[#0e1726] h-full">
                ...
                <perfect-scrollbar :options="{
                    ...
                    <ul class="relative font-semibold space-y-0.5 p-4 py-0">
                            ...
                            <ul>
                                ...
                                <li class="menu nav-item">
                                    <button type="button" class="nav-link group w-full"
                                        :class="{ active: (activeDropdown === ('/admin/apps/invoice') || $page.url.startsWith('/admin/apps/invoice')) }"
                                        @click="activeDropdown === '/admin/apps/invoice' ? (activeDropdown = null) : (activeDropdown = '/admin/apps/invoice')">
                                        <div class="flex items-center">
                                            <svg class="group-hover:!text-primary" width="20" height="20"
                                                viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <div class="rtl:rotate-180"
                                            :class="{ '!rotate-90': activeDropdown === '/admin/apps/invoice' }">
                        ...
                        <li class="menu nav-item">
                            <button type="button" class="nav-link group w-full"
                                :class="{ active: (activeDropdown === ('/admin/components') || $page.url.startsWith('/admin/components')) }"
                                @click="activeDropdown === '/admin/components' ? (activeDropdown = null) : (activeDropdown = '/admin/components')">
                                <div class="flex items-center">
                                    <svg class="group-hover:!text-primary" width="20" height="20" viewBox="0 0 24 24"
                                        fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path
                                ...
                                <div class="rtl:rotate-180"
                                    :class="{ '!rotate-90': activeDropdown === '/admin/components' }">
                                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path d="M9 5L15 12L9 19" stroke="currentColor" stroke-width="1.5"
                                            stroke-linecap="round" stroke-linejoin="round" />
                        ...
                        <li class="menu nav-item">
                            <button type="button" class="nav-link group w-full"
                                :class="{ active: (activeDropdown === ('/admin/elements') || $page.url.startsWith('/admin/elements')) }"
                                @click="activeDropdown === '/admin/elements' ? (activeDropdown = null) : (activeDropdown = '/admin/elements')">
                                <div class="flex items-center">
                                ...
                                <div class="rtl:rotate-180"
                                    :class="{ '!rotate-90': activeDropdown === '/admin/elements' }">
                                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path d="M9 5L15 12L9 19" stroke="currentColor" stroke-width="1.5"
                                            stroke-linecap="round" stroke-linejoin="round" />
                        ...
                        <li class="menu nav-item">
                            <button type="button" class="nav-link group w-full"
                                :class="{ active: (activeDropdown === ('/admin/datatables') || $page.url.startsWith('/admin/datatables')) }"
                                @click="activeDropdown === '/admin/datatables' ? (activeDropdown = null) : (activeDropdown = '/admin/datatables')">
                                <div class="flex items-center">
                                    <svg class="group-hover:!text-primary" width="20" height="20" viewBox="0 0 24 24"
                                        fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path
                                ...
                                <div class="rtl:rotate-180"
                                    :class="{ '!rotate-90': activeDropdown === '/admin/datatables' }">
                                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path d="M9 5L15 12L9 19" stroke="currentColor" stroke-width="1.5"
                                            stroke-linecap="round" stroke-linejoin="round" />
                        ...
                        <li class="menu nav-item">
                            <button type="button" class="nav-link group w-full"
                                :class="{ active: (activeDropdown === ('/admin/form') || $page.url.startsWith('/admin/form')) }"
                                @click="activeDropdown === '/admin/form' ? (activeDropdown = null) : (activeDropdown = '/admin/form')">
                                <div class="flex items-center">
                                    <svg class="group-hover:!text-primary" width="20" height="20" viewBox="0 0 24 24"
                                        fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path opacity="0.5"
                                ...
                                <div class="rtl:rotate-180" :class="{ '!rotate-90': activeDropdown === '/admin/form' }">
                                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path d="M9 5L15 12L9 19" stroke="currentColor" stroke-width="1.5"
                                            stroke-linecap="round" stroke-linejoin="round" />
                        ...
                        <li class="menu nav-item">
                            <button type="button" class="nav-link group w-full"
                                :class="{ active: (activeDropdown === ('/admin/users') || $page.url.startsWith('/admin/users')) }"
                                @click="activeDropdown === '/admin/users' ? (activeDropdown = null) : (activeDropdown = '/admin/users')">
                                <div class="flex items-center">
                                    <svg class="group-hover:!text-primary" width="20" height="20" viewBox="0 0 24 24"
                                        fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div class="rtl:rotate-180"
                                    :class="{ '!rotate-90': activeDropdown === '/admin/users' }">
                                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path d="M9 5L15 12L9 19" stroke="currentColor" stroke-width="1.5"
                                            stroke-linecap="round" stroke-linejoin="round" />
                        ...
                        <li class="menu nav-item">
                            <button type="button" class="nav-link group w-full"
                                :class="{ active: (['/admin/pages', '/admin/pages/error'].includes(activeDropdown)) }"
                                @click="activeDropdown === '/admin/pages' ? (activeDropdown = null) : (activeDropdown = '/admin/pages')">
                                <div class="flex items-center">
                                    <svg class="group-hover:!text-primary" width="20" height="20" viewBox="0 0 24 24"
                                        fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path opacity="0.5" fill-rule="evenodd" clip-rule="evenodd"
                                ...
                                <div class="rtl:rotate-180"
                                    :class="{ '!rotate-90': ['/admin/pages', '/admin/pages/error'].includes(activeDropdown) }">
                                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path d="M9 5L15 12L9 19" stroke="currentColor" stroke-width="1.5"
                                            stroke-linecap="round" stroke-linejoin="round" />
                                ...
                                <ul class="sub-menu text-gray-500">
                                    ...
                                    <li class="menu nav-item">
                                        <button type="button"
                                            ...
                                            @click="subActive === '/admin/pages/error' ? (subActive = null) : (subActive = '/admin/pages/error')">
                                            Error
                                            <div class="ltr:ml-auto rtl:mr-auto rtl:rotate-180"
                                                :class="{ '!rotate-90': subActive === '/admin/pages/error' }">
                                                <svg width="16" height="16" viewBox="0 0 24 24" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <path opacity="0.5"
